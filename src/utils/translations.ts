...
const dictionary: Record<string, Record<Language, string>> = {
  ...
  'Manage technical items and tracking': { en: 'Manage technical items and tracking', fr: 'Gérer les articles techniques et le suivi', ar: 'إدارة المواد التقنية والتتبع' },
