...
const dictionary: Record<string, Record<Language, string>> = {
  ...
  'Communes': { en: 'Communes', fr: 'Communes', ar: 'الجماعات' },
  'Services': { en: 'Services', fr: 'Services', ar: 'الخدمات' },
  'Types': { en: 'Types', fr: 'Types', ar: 'الأنواع' },
  'Avg Services': { en: 'Avg Services', fr: 'Services Moy.', ar: 'متوسط الخدمات' },
  'Key Facilities': { en: 'Key Facilities', fr: 'Installations Clés', ar: 'المرافق الأساسية' },
  'Wudu Facilities': { en: 'Wudu Facilities', fr: 'Lieux d\'ablutions', ar: 'أماكن الوضوء' },
  'Women Space': { en: 'Women Space', fr: 'Espace Femmes', ar: 'مصلى النساء' },
  'Category': { en: 'Category', fr: 'Catégorie', ar: 'الفئة' },
  'Deep Analysis': { en: 'Deep Analysis', fr: 'Analyse Approfondie', ar: 'تحليل معمق' },
  'Explorer': { en: 'Explorer', fr: 'Explorateur', ar: 'المستكشف' },
  'Custom Breakdown': { en: 'Custom Breakdown', fr: 'Répartition Personnalisée', ar: 'تفصيل مخصص' },
  'Select a dimension to analyze': { en: 'Select a dimension to analyze', fr: 'Sélectionnez une dimension à analyser', ar: 'اختر بعداً للتحليل' },
  'Distribution by': { en: 'Distribution by', fr: 'Distribution par', ar: 'التوزيع حسب' },
  'Filter by Type': { en: 'Filter by Type', fr: 'Filtrer par type', ar: 'تصفية حسب النوع' },
  'Select Type': { en: 'Select Type', fr: 'Sélectionner un type', ar: 'اختر النوع' },
  'Clear Filters': { en: 'Clear Filters', fr: 'Effacer les filtres', ar: 'مسح الفلاتر' },
  'Matching Mosques': { en: 'Matching Mosques', fr: 'Mosquées correspondantes', ar: 'المساجد المطابقة' },
  'Live Stats': { en: 'Live Stats', fr: 'Stats en direct', ar: 'إحصائيات مباشرة' },
  'Top Matching Localities': { en: 'Top Matching Localities', fr: 'Localités les plus fréquentes', ar: 'أكثر المناطق مطابقة' },
  'Results matching your current filters and search criteria.': { en: 'Results matching your current filters and search criteria.', fr: 'Résultats correspondant à vos filtres et critères de recherche.', ar: 'النتائج المطابقة للفلاتر ومعايير البحث الحالية.' },
  'Search by name, service, or items...': { en: 'Search by name, service, or items...', fr: 'Rechercher par nom, service ou éléments...', ar: 'بحث بالاسم أو الخدمة أو العناصر...' },
  'No data matching filters': { en: 'No data matching filters', fr: 'Aucune donnée correspondant aux filtres', ar: 'لا توجد بيانات تطابق الفلاتر' },
  'Analysis is currently filtered to': { en: 'Analysis is currently filtered to', fr: 'L\'analyse est actuellement filtrée sur', ar: 'التحليل مصفى حالياً حسب' },
  'All Communes': { en: 'All Communes', fr: 'Toutes les communes', ar: 'جميع الجماعات' },
  'All Types': { en: 'All Types', fr: 'Tous les types', ar: 'جميع الأنواع' },
  'Custom Analysis': { en: 'Custom Analysis', fr: 'Analyse Personnalisée', ar: 'تحليل مخصص' },
  'Compare': { en: 'Compare', fr: 'Comparer', ar: 'مقارنة' },
  'Intelligence': { en: 'Intelligence', fr: 'Intelligence', ar: 'ذكاء' },
  'Data Insights': { en: 'Data Insights', fr: 'Aperçus des données', ar: 'رؤى البيانات' },
  'Correlation': { en: 'Correlation', fr: 'Corrélation', ar: 'ارتباط' },
  'Select Basis': { en: 'Select Basis', fr: 'Choisir la base', ar: 'اختر الأساس' },
  'Metric': { en: 'Metric', fr: 'Métrique', ar: 'المقياس' },
  'Distribution': { en: 'Distribution', fr: 'Distribution', ar: 'التوزيع' },
  'Mosque Density': { en: 'Mosque Density', fr: 'Densité des mosquées', ar: 'كثافة المساجد' },
  'A breakdown of mosques by geographical location.': { en: 'A breakdown of mosques by geographical location.', fr: 'Une répartition des mosquées par emplacement géographique.', ar: 'توزيع المساجد حسب الموقع الجغرافي.' },
  'Common Amenities': { en: 'Common Amenities', fr: 'Commodités communes', ar: 'المرافق العامة' },
  'Category Breakdown': { en: 'Category Breakdown', fr: 'Répartition par catégorie', ar: 'توزيع الفئات' },
  'Structural Trends': { en: 'Structural Trends', fr: 'Tendances Structurelles', ar: 'الاتجاهات الهيكلية' },
  'Complexity Score': { en: 'Complexity Score', fr: 'Score de complexité', ar: 'مؤشر التعقيد' },
  'Sample Size': { en: 'Sample Size', fr: 'Taille de l\'échantillon', ar: 'حجم العينة' },
  'Not enough data for intelligence analysis': { en: 'Not enough data for intelligence analysis', fr: 'Pas assez de données pour l\'analyse intelligente', ar: 'بيانات غير كافية للتحليل الذكي' },
  'Excellent coverage of wudu facilities across the selected mosques.': { en: 'Excellent coverage of wudu facilities across the selected mosques.', fr: 'Excellente couverture des installations de wudu dans les mosquées sélectionnées.', ar: 'تغطية ممتازة لمرافق الوضوء في المساجد المختارة.' },
  'Significant need for improved wudu facilities in this selection.': { en: 'Significant need for improved wudu facilities in this selection.', fr: 'Besoin important d\'amélioration des installations de wudu dans cette sélection.', ar: 'حاجة ماسة لتحسين مرافق الوضوء في هذه المجموعة.' },
  'High availability of designated spaces for women in these localities.': { en: 'High availability of designated spaces for women in these localities.', fr: 'Grande disponibilité d\'espaces réservés aux femmes dans ces localités.', ar: 'توفر عالٍ للمساحات المخصصة للنساء في هذه المناطق.' },
  'Most mosques in this category are classified as': { en: 'Most mosques in this category are classified as', fr: 'La plupart des mosquées de cette catégorie sont classées comme', ar: 'معظم المساجد في هذه الفئة مصنفة كـ' },
  'has significantly better equipped mosques than average.': { en: 'has significantly better equipped mosques than average.', fr: 'possède des mosquées nettement mieux équipées que la moyenne.', ar: 'تمتلك مساجد مجهزة بشكل أفضل بكثير من المتوسط.' },
  'Selection Profile': { en: 'Selection Profile', fr: 'Profil de la sélection', ar: 'ملف تعريف المجموعة' },
  'Mosques with Women Hall': { en: 'Mosques with Women Hall', fr: 'Mosquées avec salle femmes', ar: 'مساجد بها قاعة صلاة للنساء' },
  'Mosques with Accessibility': { en: 'Mosques with Accessibility', fr: 'Mosquées avec accès handicapé', ar: 'مساجد تتوفر على ولوجيات' },
  'Dynamic Analysis': { en: 'Dynamic Analysis', fr: 'Analyse Dynamique', ar: 'تحليل ديناميكي' },
  'Select an Attribute': { en: 'Select an Attribute', fr: 'Sélectionner un attribut', ar: 'اختر ميزة' },
  'Analyze': { en: 'Analyze', fr: 'Analyser', ar: 'تحليل' },
  'Percentage': { en: 'Percentage', fr: 'Pourcentage', ar: 'النسبة المئوية' },
  'Distribution by Commune': { en: 'Distribution by Commune', fr: 'Distribution par commune', ar: 'التوزيع حسب الجماعة' },
  'Distribution by Category': { en: 'Distribution by Category', fr: 'Distribution par catégorie', ar: 'التوزيع حسب الفئة' },
  'Deep Insights': { en: 'Deep Insights', fr: 'Ressources Approfondies', ar: 'رؤى عميقة' },
